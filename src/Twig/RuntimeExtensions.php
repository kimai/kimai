...
final class RuntimeExtensions extends AbstractExtension
{
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('timesheet_hard_limit', [TimesheetExtension::class, 'activeEntriesHardLimit']),
            new TwigFunction('ticktack_entries', [TimesheetExtension::class, 'ticktackEntries']),
            new TwigFunction('ticktack_excludes', [TimesheetExtension::class, 'ticktackExcludes']),
