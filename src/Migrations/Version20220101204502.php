...
final class Version20220101204502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kimai2_timesheet CHANGE exported exported TINYINT(1) DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE kimai2_timesheet CHANGE billable billable TINYINT(1) DEFAULT 1 NOT NULL');
    }
