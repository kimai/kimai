...
final class Version20181031220003 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        if ($platform === 'sqlite') {
            ...
            $this->addSql('ALTER TABLE ' . $timesheet . ' ADD project_id INT DEFAULT NULL AFTER activity_id, CHANGE user user INT DEFAULT NULL, CHANGE activity_id activity_id INT DEFAULT NULL');
