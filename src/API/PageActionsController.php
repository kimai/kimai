...
#[OA\Tag(name: 'Actions')]
final class PageActionsController extends BaseApiController
{
    ...
    /**
     * Get all page actions for the given Timesheet (for internal use!)
     */
    #[OA\Response(response: 200, description: 'Returns one activity entity', content: new OA\JsonContent(ref: new Model(type: PageAction::class)))]
    ...
    public function getAction(Timesheet $timesheet, string $view, string $locale): Response
    {
