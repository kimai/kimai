...
class WizardSubscriberTest extends TestCase
{
    ...
    {
        self::assertEquals([KernelEvents::REQUEST => ['onKernelRequest']], WizardSubscriber::getSubscribedEvents());
    }
    ...
    public function testOnKernelRequestPasswordResetRedirectTakesPrecedenceOverWizardRedirect(): void
    {
        $user = new User();
        $user->setEnabled(true);
        $user->setRequiresPasswordReset();
