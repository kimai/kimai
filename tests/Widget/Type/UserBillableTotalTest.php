...
use App\Widget\Type\UserBillableTotal;
use App\Widget\WidgetInterface;

/**
 * @covers \App\Widget\Type\UserBillableTotal
 * @covers \App\Widget\Type\AbstractBillablePercent
 */
class UserBillableTotalTest extends AbstractWidgetTypeTest
{
    /**
    ...
    public function createSut(): AbstractWidgetType
    {
        ...
        $sut = new UserBillableTotal($repository, $configuration);
    ...
    public function testSettings(): void
    {
        ...
        self::assertEquals('userBillableTotal', $sut->getId());
    }
}
