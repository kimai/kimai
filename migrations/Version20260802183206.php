 ...
 * @version 2.63
 */
final class Version20260802183206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $language = $this->connection->fetchOne("SELECT `value` FROM kimai2_configuration WHERE `name` = 'defaults.user.language'");
        if (empty($language)) {
            $language = 'en';
        }
